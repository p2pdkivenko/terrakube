    ...
    <div className="totp-setup-content">
      ...
      <div className="setup-instructions">
        ...
        <ol className="instruction-steps">
          ...
          <li>Enter a memorable name for this device (e.g., My Phone).</li>
</ol>
</div>
...
<Button onClick={onCancel} className="footer-btn">Cancel</Button>
<Button
type="primary"
htmlType="submit"
loading={verifyLoading}
disabled={code.length !== 6 || name.trim().length === 0}
